...
class XRCustomControllerModel extends Object3D{
...
class XRCustomController{
    ...
    createControllerModel( controller, filename ) {

        const controllerModel = new XRCustomControllerModel();
        let scene = null;
        ...
        controller.addEventListener( 'connected', ( event ) => {
            ...
            fetchProfile( xrInputSource, this.profilesPath, DEFAULT_PROFILE ).then( ( { profile } ) => {
